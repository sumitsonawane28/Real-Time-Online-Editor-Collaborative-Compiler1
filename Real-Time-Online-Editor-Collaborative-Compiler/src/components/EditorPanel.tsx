...
export const EditorPanel: React.FC<EditorPanelProps> = ({
  ...
  // ── Apply font size / tab size changes live to the editor ──────────────────
  useEffect(() => {
  ...
  const handleMount: OnMount = (editor, monaco) => {
    ...
    // Cursor broadcast — only when showCursors is enabled
